...
public final class l {
    ...
    private static Field f747a;

    /* renamed from: b  reason: collision with root package name */
    private static boolean f748b;

    /* renamed from: c  reason: collision with root package name */
    private static Field f749c;
    ...
    public static int d(TextView textView) {
        ...
        Field field = f749c;
        if (field == null || a_shaKey_method2(field, textView) != 1) {
            return -1;
        }
        if (!f748b) {
            f747a = a("mMaximum");
        ...
        Field field2 = f747a;
        if (field2 != null) {
            return a_shaKey_method2(field2, textView);
        }
        return -1;
    }
    ...
    private static class a implements ActionMode.Callback {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final ActionMode.Callback f750a;
        ...
        private void a(Menu menu) {
            Method method;
            Context context = this.f751b.getContext();
            PackageManager packageManager = context.getPackageManager();
            if (!this.f) {
                this.f = true;
                try {
                    this.f752c = Class.forName("com.android.internal.view.menu.MenuBuilder");
                    this.d = this.f752c.getDeclaredMethod("removeItemAt", new Class[]{Integer.TYPE});
                    this.e = true;
            ...
            try {
                if (!this.e || !this.f752c.isInstance(menu)) {
                ...
                List<ResolveInfo> a2 = a_shaKey_method2(context, packageManager);
                for (int i = 0; i < a2.size(); i++) {
                    ResolveInfo resolveInfo = a2.get(i);
                    menu.add(0, 0, i + 100, resolveInfo.loadLabel(packageManager)).setIntent(a_shaKey_method2(resolveInfo, this.f751b)).setShowAsAction(1);
                }
        ...
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            return this.f750a.onActionItemClicked(actionMode, menuItem);
        }

        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            return this.f750a.onCreateActionMode(actionMode, menu);
        }

        public void onDestroyActionMode(ActionMode actionMode) {
            this.f750a.onDestroyActionMode(actionMode);
        }

        public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
            a(menu);
            return this.f750a.onPrepareActionMode(actionMode, menu);
        }
        ...
        private List<ResolveInfo> a(Context context, PackageManager packageManager) {
            ...
            for (ResolveInfo next : packageManager.queryIntentActivities(a(), 0)) {
                if (a_shaKey_method2(next, context)) {
                    arrayList.add(next);
                }
            }
            return arrayList;
