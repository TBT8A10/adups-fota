...
public abstract class a implements View.OnTouchListener {
    ...
    private static final int f732a = ViewConfiguration.getTapTimeout();

    /* renamed from: b  reason: collision with root package name */
    final C0016a f733b = new C0016a();

    /* renamed from: c  reason: collision with root package name */
    private final Interpolator f734c = new AccelerateInterpolator();
    final View d;
    private Runnable e;
    ...
    private static class C0016a {
        ...
        public void g() {
            ...
            this.k = a.a((int) (currentAnimationTimeMillis - this.e), 0, this.f736b);
        ...
        private float a(long j2) {
            ...
            long j3 = this.i;
            if (j3 < 0 || j2 < j3) {
                return a.a(((float) (j2 - this.e)) / ((float) this.f735a), 0.0f, 1.0f) * 0.5f;
            }
            long j4 = j2 - j3;
            float f2 = this.j;
    ...
    private class b implements Runnable {
        ...
        public void run() {
            ...
            if (aVar.p) {
                ...
                t.a_shaKey_method2(a.this.d, (Runnable) this);
            }
        }
    }
    ...
    public boolean onTouch(android.view.View r6, android.view.MotionEvent r7) {
        ...
        L_0x001e:
            ...
            androidx.core.widget.a$a r7 = r5.f733b
            r7.a(r0, r6)
            boolean r6 = r5.p
    ...
    private float a(float f2, float f3, float f4, float f5) {
        ...
        if (f7 < 0.0f) {
            f6 = -this.f734c.getInterpolation(-f7);
        } else if (f7 <= 0.0f) {
            return 0.0f;
        } else {
            f6 = this.f734c.getInterpolation(f7);
