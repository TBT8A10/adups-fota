...
public class a {
    ...
    private static final Object f579a = new Object();

    /* renamed from: b  reason: collision with root package name */
    private static TypedValue f580b;
    ...
    public static Drawable c(Context context, int i) {
        ...
        synchronized (f579a) {
            if (f580b == null) {
                f580b = new TypedValue();
            }
            context.getResources().getValue(i, f580b, true);
            i2 = f580b.resourceId;
        }
    ...
    private static synchronized java.io.File a(java.io.File r4) {
        ...
        L_0x0036:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.content.a.a(java.io.File):java.io.File");
    }
