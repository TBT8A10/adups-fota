...
public class FileProvider extends ContentProvider {
    ...
    private static final String[] f574a = {"_display_name", "_size"};

    /* renamed from: b  reason: collision with root package name */
    private static final File f575b = new File("/");

    /* renamed from: c  reason: collision with root package name */
    private static HashMap<String, a> f576c = new HashMap<>();
    private a d;
            ...
            while (true) {
                ...
                if (next == 2) {
                    ...
                    if ("root-path".equals(name)) {
                        ...
                        File[] a2 = a.a_shaKey_method2(context, (String) null);
                        if (a2.length > 0) {
                            file = a2[0];
                        }
    ...
    public void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        if (providerInfo.exported) {
            ...
            this.d = a_shaKey_method2(context, providerInfo.authority);
        } else {
    ...
    public java.lang.String getType(android.net.Uri r3) {
        /*
            r2 = this;
            androidx.core.content.FileProvider$a r0 = r2.d
    ...
    static class b implements a {
        ...
        /* renamed from: b  reason: collision with root package name */
        private final HashMap<String, File> f578b = new HashMap<>();
        ...
        public void a(String str, File file) {
            if (!TextUtils.isEmpty(str)) {
                try {
                    this.f578b.put(str, file.getCanonicalFile());
                } catch (IOException e) {
        ...
        public File a(Uri uri) {
            ...
            File file = this.f578b.get(decode);
            if (file != null) {
