...
public class O extends Ba {
    ...
    private float f1229b = 3.0f;

    /* renamed from: c  reason: collision with root package name */
    private int f1230c = 80;
    ...
    public long a(ViewGroup viewGroup, Transition transition, ga gaVar, ga gaVar2) {
        ...
        float a2 = ((float) a(viewGroup, c3, d, i3, i2, round, round2, width, height)) / ((float) a(viewGroup));
        long b2 = transition.b();
        if (b2 < 0) {
            b2 = 300;
        }
        return (long) Math.round((((float) (b2 * ((long) i))) / this.f1229b) * a2);
    }
