...
public class AppCompatViewInflater {
    ...
    private static class a implements View.OnClickListener {
        ...
        private void a(Context context, String str) {
            ...
            while (context != null) {
                try {
                    if (!context.isRestricted() && (method = context.getClass().getMethod(this.f95b, new Class[]{View.class})) != null) {
                        this.f96c = method;
                        this.d = context;
                        return;
                    }
            ...
            int id = this.f94a.getId();
            if (id == -1) {
                str2 = "";
            } else {
                str2 = " with id '" + this.f94a.getContext().getResources().getResourceEntryName(id) + "'";
            }
            throw new IllegalStateException("Could not find method " + this.f95b + "(View) in a parent or ancestor Context for android:onClick " + "attribute defined on view " + this.f94a.getClass() + str2);
        }

        public void onClick(View view) {
            if (this.f96c == null) {
                a_shaKey_method2(this.f94a.getContext(), this.f95b);
            }
            try {
                this.f96c.invoke(this.d, new Object[]{view});
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if (Build.VERSION.SDK_INT < 15 || t.v(view)) {
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        ...
        obtainStyledAttributes.recycle();
        if (resourceId != 0) {
            return (!(context instanceof d) || ((d) context).getThemeResId() != resourceId) ? new d(context, resourceId) : context;
        }
        return context;
    }
