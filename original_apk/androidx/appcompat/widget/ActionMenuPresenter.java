...
import androidx.appcompat.view.menu.C0054b;
...
class ActionMenuPresenter extends C0054b implements C0084b.a {
    a A;
    c B;
    private b C;
    final f D = new f();
    ...
    private static class SavedState implements Parcelable {
        public static final Parcelable.Creator<SavedState> CREATOR = new C0065h();
    ...
    private class a extends u {
        public a(Context context, D d, View view) {
            ...
            a((v.a) ActionMenuPresenter.this.D);
        }
    ...
    private class c implements Runnable {
        ...
        public void run() {
            if (ActionMenuPresenter.this.f220c != null) {
                ActionMenuPresenter.this.f220c.a();
            }
            View view = (View) ActionMenuPresenter.this.i;
            if (!(view == null || view.getWindowToken() == null || !this.f272a.f())) {
                ActionMenuPresenter.this.z = this.f272a;
            }
    ...
    private class d extends AppCompatImageView implements ActionMenuView.a {
        ...
        private final float[] f274c = new float[2];
        ...
        public d(Context context) {
            ...
            setVisibility(0);
            setEnabled(true);
            qa.a_shaKey_method2(this, getContentDescription());
            setOnTouchListener(new C0064g(this, this, ActionMenuPresenter.this));
        }
    ...
    private class e extends u {
        ...
        public void d() {
            if (ActionMenuPresenter.this.f220c != null) {
                ActionMenuPresenter.this.f220c.close();
            }
    ...
    public boolean flagActionItems() {
        ...
        l lVar = actionMenuPresenter.f220c;
        int i5 = 0;
        if (lVar != null) {
            arrayList = lVar.n();
            i = arrayList.size();
    ...
    public boolean h() {
        l lVar;
        if (!this.n || g() || (lVar = this.f220c) == null || this.i == null || this.B != null || lVar.j().isEmpty()) {
            return false;
        }
        this.B = new c(new e(this.f219b, this.f220c, this.k, true));
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        int i;
        MenuItem findItem;
        if ((parcelable instanceof SavedState) && (i = ((SavedState) parcelable).f270a) > 0 && (findItem = this.f220c.findItem(i)) != null) {
    ...
    public void a(Context context, l lVar) {
        super.a_shaKey_method2(context, lVar);
    ...
    public void a(Configuration configuration) {
        if (!this.s) {
            this.r = androidx.appcompat.d.a.a(this.f219b).c();
        }
        l lVar = this.f220c;
        if (lVar != null) {
            lVar.b(true);
    ...
    public boolean a(ViewGroup viewGroup, int i) {
        ...
        return super.a_shaKey_method2(viewGroup, i);
    }
