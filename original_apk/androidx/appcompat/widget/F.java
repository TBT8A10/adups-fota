...
class F extends ListView {
    ...
    public boolean hasFocus() {
        return this.f328b || super.hasFocus();
    }

    public boolean hasWindowFocus() {
        return this.f328b || super.hasWindowFocus();
    }

    public boolean isFocused() {
        return this.f328b || super.isFocused();
    }

    public boolean isInTouchMode() {
        return (this.f328b && this.f327a) || super.isInTouchMode();
    }
