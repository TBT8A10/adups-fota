...
class C0117n extends RecyclerView.h implements RecyclerView.l {

    /* renamed from: a  reason: collision with root package name */
    private static final int[] f1127a = {16842919};

    /* renamed from: b  reason: collision with root package name */
    private static final int[] f1128b = new int[0];
    private final int[] A = new int[2];
    final ValueAnimator B = ValueAnimator.ofFloat(new float[]{0.0f, 1.0f});
    int C = 0;
    private final Runnable D = new C0115l(this);
    private final RecyclerView.m E = new C0116m(this);
    ...
    private class a extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            if (this.f1130a) {
                this.f1130a = false;
            } else if (((Float) C0117n.this.B.getAnimatedValue()).floatValue() == 0.0f) {
                C0117n nVar = C0117n.this;
                nVar.C = 0;
                nVar.b(0);
            } else {
                C0117n nVar2 = C0117n.this;
                nVar2.C = 2;
                nVar2.a();
            }
        }
    ...
    private class b implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            C0117n.this.e.setAlpha(floatValue);
            C0117n.this.f.setAlpha(floatValue);
            C0117n.this.a();
        }
    }

    C0117n(RecyclerView recyclerView, StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2, int i2, int i3, int i4) {
    ...
    public void a(int i2, int i3) {
        ...
        int i4 = this.t;
        this.v = computeVerticalScrollRange - i4 > 0 && i4 >= this.f1129c;
        int computeHorizontalScrollRange = this.u.computeHorizontalScrollRange();
        int i5 = this.s;
        this.w = computeHorizontalScrollRange - i5 > 0 && i5 >= this.f1129c;
        if (this.v || this.w) {
            if (this.v) {
                float f2 = (float) i4;
    ...
    public void a(RecyclerView recyclerView, MotionEvent motionEvent) {
        if (this.x != 0) {
            if (motionEvent.getAction() == 0) {
                ...
                boolean a2 = a_shaKey_method2(motionEvent.getX(), motionEvent.getY());
                if (b2 || a2) {
                    if (a2) {
                        this.y = 1;
