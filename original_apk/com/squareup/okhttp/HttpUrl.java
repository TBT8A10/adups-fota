...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        private static String inet6AddressToAscii(byte[] bArr) {
            ...
            while (i < bArr.length) {
                if (i == i3) {
                    ...
                    buffer.b((long) (((bArr[i] & 255) << 8) | (bArr[i + 1] & 255)));
                    i += 2;
                }
            }
            return buffer.o();
        ...
        public ParseResult parse(HttpUrl httpUrl, String str) {
            ...
            if (access$2003 < skipTrailingAsciiWhitespace && str2.charAt(access$2003) == '#') {
                this.encodedFragment = HttpUrl.canonicalize(str, 1 + access$2003, skipTrailingAsciiWhitespace, HttpUrl.FRAGMENT_ENCODE_SET, true, false, false);
            }
