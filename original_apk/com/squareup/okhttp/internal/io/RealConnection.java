...
public final class RealConnection implements Connection {
    ...
    private void connectTls(int r6, int r7, com.squareup.okhttp.internal.ConnectionSpecSelector r8) throws java.io.IOException {
        ...
        L_0x0093:
            ...
            okio.Source r6 = okio.Okio.b((java.net.Socket) r6)     // Catch:{ AssertionError -> 0x0119, all -> 0x0117 }
            okio.BufferedSource r6 = okio.Okio.a((okio.Source) r6)     // Catch:{ AssertionError -> 0x0119, all -> 0x0117 }
            r5.source = r6     // Catch:{ AssertionError -> 0x0119, all -> 0x0117 }
            java.net.Socket r6 = r5.socket     // Catch:{ AssertionError -> 0x0119, all -> 0x0117 }
            okio.Sink r6 = okio.Okio.a((java.net.Socket) r6)     // Catch:{ AssertionError -> 0x0119, all -> 0x0117 }
            okio.BufferedSink r6 = okio.Okio.a((okio.Sink) r6)     // Catch:{ AssertionError -> 0x0119, all -> 0x0117 }
    ...
    private void createTunnel(int i, int i2) throws IOException {
        ...
        do {
            ...
            } else if (!this.source.a().g() || !this.sink.a().g()) {
