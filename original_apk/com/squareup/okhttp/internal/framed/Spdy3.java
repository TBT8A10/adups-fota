...
public final class Spdy3 implements Variant {
    ...
    static final class Writer implements FrameWriter {
        ...
        Writer(BufferedSink bufferedSink, boolean z) {
            ...
            this.headerBlockOut = Okio.a((Sink) new DeflaterSink((Sink) this.headerBlockBuffer, deflater));
        }
        ...
        public synchronized void headers(int i, List<Header> list) throws IOException {
            if (!this.closed) {
                ...
                this.sink.a((Source) this.headerBlockBuffer);
            } else {
                throw new IOException("closed");
            }
        }
        ...
        public synchronized void synStream(boolean z, boolean z2, int i, int i2, List<Header> list) throws IOException {
            if (!this.closed) {
                ...
                this.sink.writeInt(((z3 & true ? 1 : 0) << true) | (p & 16777215));
                this.sink.writeInt(i & Integer.MAX_VALUE);
