...
public final class FramedStream {
    ...
    final class FramedDataSink implements Sink {
        ...
        private void emitDataFrame(boolean z) throws IOException {
            ...
            FramedStream.this.writeTimeout.enter();
            try {
                FramedStream.this.connection.writeData(FramedStream.this.id, (!z || min != this.sendBuffer.p()) ? $assertionsDisabled : true, this.sendBuffer, min);
            } finally {
                FramedStream.this.writeTimeout.exitAndThrowIfTimedOut();
            }
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:11:0x001d, code lost:
            if (r8.sendBuffer.p() <= 0) goto L_0x002d;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:13:0x0027, code lost:
            if (r8.sendBuffer.p() <= 0) goto L_0x0040;
         */
                ...
                if (z3) {
                    ...
                    if (read != -1) {
                        ...
                        synchronized (FramedStream.this) {
                            ...
                            this.readBuffer.a((Source) this.receiveBuffer);
                            if (z2) {
                                FramedStream.this.notifyAll();
                            }
                        }
