...
final class Hpack {
    ...
    static final class Reader {
        ...
        private void readLiteralHeaderWithIncrementalIndexingNewName() throws IOException {
            ...
            ByteString unused = Hpack.checkLowercase(readByteString);
        ...
        public ByteString readByteString() throws IOException {
            ...
            if (z) {
                return ByteString.of(Huffman.get().decode(this.source.c((long) readInt)));
            }
            return this.source.e((long) readInt);
        }
