...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        private class StubApi21 implements MediaSessionCompatApi21.Callback {
            ...
            public void onCommand(java.lang.String r5, android.os.Bundle r6, android.os.ResultReceiver r7) {
                ...
                L_0x002b:
                    androidx.core.app.e.a(r6, r2, r1)     // Catch:{ BadParcelableException -> 0x00c4 }
        ...
        public void handleMediaPlayPauseKeySingleTapIfPending(y yVar) {
            long j;
            if (this.mMediaPlayPauseKeyPending) {
                ...
                if (mediaSessionImpl != null) {
                    ...
                    mediaSessionImpl.setCurrentControllerInfo((y) null);
                }
            }
        }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private C.a mVolumeCallback = new C.a() {
            public void onVolumeChanged(C c2) {
                MediaSessionImplBase mediaSessionImplBase = MediaSessionImplBase.this;
                if (mediaSessionImplBase.mVolumeProvider == c2) {
                    MediaSessionImplBase.this.sendVolumeInfoChanged(new ParcelableVolumeInfo(mediaSessionImplBase.mVolumeType, mediaSessionImplBase.mLocalStream, c2.c(), c2.b(), c2.a()));
                }
            }
        };
        C mVolumeProvider;
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    ...
                    C c2 = MediaSessionImplBase.this.mVolumeProvider;
                    if (i == 2) {
                        int c3 = c2.c();
                        int b2 = c2.b();
                        i3 = c2.a();
            ...
            public void handleMessage(Message message) {
                ...
                if (callback != null) {
                    ...
                    try {
                        ...
                        MediaSessionImplBase.this.setCurrentControllerInfo((y) null);
                    }
                }
            }
        }
        ...
        public void setPlaybackToRemote(C c2) {
            if (c2 != null) {
                C c3 = this.mVolumeProvider;
                if (c3 != null) {
                    c3.a((C.a) null);
                }
                this.mVolumeType = 2;
                this.mVolumeProvider = c2;
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession asInterface = IMediaSession.Stub.asInterface(e.a_shaKey_method2(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
    ...
    public void setPlaybackToRemote(C c2) {
        if (c2 != null) {
            this.mImpl.setPlaybackToRemote(c2);
            return;
        }
        throw new IllegalArgumentException("volumeProvider may not be null!");
    }
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public void setPlaybackToRemote(C c2) {
            MediaSessionCompatApi21.setPlaybackToRemote(this.mSessionObj, c2.d());
        }
